		...
		try {
			...
			if (type == 1) {
				...
				if (object.get("status") == null
						|| "0".equals(object.get("status"))) {
					return new ResponseStatus(300, "False!");
				} else {
					return new ResponseStatus(100, object.get("sign") + ","
							+ object.get("ts") + "," + object.get("channel"),
							"success!");
				}
			} else {
...
//					log.debug(str);
	...
	public static void main(String[] args) {
		System.out.println(new GetAmapresult().select("北京大学"));
	}
}
